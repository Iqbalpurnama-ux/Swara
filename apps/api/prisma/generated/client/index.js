...
exports.Prisma.VoicePackScalarFieldEnum = {
  id: 'id',
  voiceName: 'voiceName',
  provider: 'provider',
  isPremium: 'isPremium',
...
const config = {
  "generator": {
    ...
    "output": {
      "value": "D:\\Indi\\swara\\apps\\api\\prisma\\generated\\client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "D:\\Indi\\swara\\apps\\api\\prisma\\schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null
...
path.join(process.cwd(), "apps/api/prisma/generated/client/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "apps/api/prisma/generated/client/schema.prisma")
