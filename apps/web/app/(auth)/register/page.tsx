    ...
    <div className="min-h-screen bg-[#F8FAFC] flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-lg w-full max-w-[420px] p-8">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-[#0F172A] mb-2">Buat Akun Swara</h1>
          <p className="text-[#334155]">Mulai perjalanan komunikasi inklusif</p>
        </div>
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <span className="text-sm text-[#94A3B8]">atau daftar dengan email</span>
          <div className="flex-1 h-px bg-[#E2E8F0]"></div>
        </div>
